...
export class Recommender {
    ...
    save() {
        sessionStorage.recommenderKeywords = JSON.stringify(this.keywords);
    };

    /* Loads state of recommender */
    load() {
        if (sessionStorage.recommenderKeywords === undefined)
            this.keywords = {};
        else
            this.keywords = JSON.parse(sessionStorage.recommenderKeywords);
